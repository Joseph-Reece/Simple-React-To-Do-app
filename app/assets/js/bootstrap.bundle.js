...
(function(global, factory) {
  ...
  let getTransitionDurationFromElement = function getTransitionDurationFromElement(
    element,
  ) {
    if (!element) {
      return 0;
  ...
  let typeCheckConfig = function typeCheckConfig(
    componentName,
    config,
    configTypes,
  ) {
  ...
  function addHandler(
    ...
    let _normalizeParams = normalizeParams(
        originalTypeEvent,
        handler,
        delegationFn,
  ...
  var EventHandler = {
    ...
    off: function off(element, originalTypeEvent, handler, delegationFn) {
      ...
      let _normalizeParams2 = normalizeParams(
          originalTypeEvent,
          handler,
          delegationFn,
  ...
  let Carousel = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    _proto._setActiveIndicatorElement = function _setActiveIndicatorElement(
      ...
      if (this._indicatorsElement) {
        let indicators = SelectorEngine.find(
          SELECTOR_ACTIVE,
    ...
    _proto._updateInterval = function _updateInterval() {
      ...
      let elementInterval = Number.parseInt(
    ...
    _proto._slide = function _slide(direction, element) {
      ...
      let activeElement = SelectorEngine.findOne(
        SELECTOR_ACTIVE_ITEM,
        this._element,
      );
      ...
      if (this._element.classList.contains(CLASS_NAME_SLIDE)) {
        ...
        let transitionDuration = getTransitionDurationFromElement(
          activeElement,
        );
  ...
  let Collapse = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    function Collapse(element, config) {
      ...
      for (let i = 0, len = toggleList.length; i < len; i++) {
        ...
        let filterElement = SelectorEngine.find(selector).filter(function(
          foundElem,
        ) {
  ...
  function arrow(_ref) {
    ...
    let {popperOffsets} = state.modifiersData;
  ...
  function mapToStyles(_ref2) {
    ...
    let _roundOffsets = roundOffsets(offsets);
        var x = _roundOffsets.x;
        var y = _roundOffsets.y;
  ...
  function getDocumentRect(element) {
    ...
    let {body} = element.ownerDocument;
    let width = Math.max(
      html.scrollWidth,
      html.clientWidth,
  ...
  */
  ...
  let Dropdown = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      let showEvent = EventHandler.trigger(
        this._element,
        EVENT_SHOW$1,
        relatedTarget,
      );
    ...
    Dropdown.clearMenus = function clearMenus(event) {
      ...
      for (let i = 0, len = toggles.length; i < len; i++) {
        ...
        let hideEvent = EventHandler.trigger(
          parent,
          EVENT_HIDE$1,
          relatedTarget,
        );
    ...
    Dropdown.dataApiKeydownHandler = function dataApiKeydownHandler(event) {
      ...
      if (event.key === ESCAPE_KEY) {
        let button = this.matches(SELECTOR_DATA_TOGGLE$2)
          ? this
      ...
      let items = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, parent).filter(
        isVisible,
      );
  ...
  let Modal = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    _proto._showBackdrop = function _showBackdrop(callback) {
      ...
      let animate = this._element.classList.contains(CLASS_NAME_FADE)
        ? CLASS_NAME_FADE
        : '';
      ...
      if (this._isShown && this._config.backdrop) {
        ...
        let backdropTransitionDuration = getTransitionDurationFromElement(
          this._backdrop,
        );
        ...
        if (this._element.classList.contains(CLASS_NAME_FADE)) {
          let _backdropTransitionDuration = getTransitionDurationFromElement(
            this._backdrop,
          );
    ...
    _proto._triggerBackdropTransition = function _triggerBackdropTransition() {
      ...
      let modalTransitionDuration = getTransitionDurationFromElement(
        this._dialog,
      );
    ...
    _proto._setScrollbar = function _setScrollbar() {
      ...
      if (this._isBodyOverflowing) {
        ...
        SelectorEngine.find(SELECTOR_FIXED_CONTENT).forEach(function(element) {
          ...
          let calculatedPadding = window.getComputedStyle(element)[
            'padding-right'
          ];
        ...
        SelectorEngine.find(SELECTOR_STICKY_CONTENT).forEach(function(element) {
          ...
          let calculatedMargin = window.getComputedStyle(element)[
            'margin-right'
          ];
        ...
        let calculatedPadding = window.getComputedStyle(document.body)[
          'padding-right'
        ];
    ...
    _proto._resetScrollbar = function _resetScrollbar() {
      ...
      let padding = Manipulator.getDataAttribute(
        document.body,
        'padding-right',
      );
  ...
  function sanitizeHtml(unsafeHtml, allowList, sanitizeFn) {
    ...
    let elements = (_ref = []).concat.apply(
      _ref,
  ...
  let Tooltip = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    _proto._fixTitle = function _fixTitle() {
      ...
      let originalTitleType = typeof this._element.getAttribute(
  ...
  let Tab = /* #__PURE__ */ (function(_BaseComponent) {
    ...
    _proto._transitionComplete = function _transitionComplete(
      ...
      if (active) {
        ...
        let dropdownChild = SelectorEngine.findOne(
