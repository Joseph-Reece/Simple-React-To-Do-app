...
!(function(t, e) {
      ...
      (r._setScrollbar = function() {
        ...
        if (this._isBodyOverflowing) {
          q
            ...
            var i = window.getComputedStyle(e)['margin-right'];
  ...
  const De = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i;
  const xe = {
