...
!(function(t, e) {
          ...
          V.find('.fixed-top, .fixed-bottom, .is-fixed, .sticky-top').forEach(
            function(e) {
              ...
              q.setDataAttribute(e, 'padding-right', n),
                (e.style.paddingRight = `${Number.parseFloat(i) +
                  t._scrollbarWidth}px`);
            },
          ),
            V.find('.sticky-top').forEach(function(e) {
              const n = e.style.marginRight;
            let i = window.getComputedStyle(e)['margin-right'];
              q.setDataAttribute(e, 'margin-right', n),
                (e.style.marginRight = `${Number.parseFloat(i) -
                  t._scrollbarWidth}px`);
            });
  ...
  const Et = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i;
  const Tt = {
    ...
    function e(e, n) {
      ...
      return (
        ...
        (i._selector = `${i._config.target} .nav-link, ${
          i._config.target
        } .list-group-item, ${i._config.target} .dropdown-item`),
        (i._offsets = []),
        (i._targets = []),
